...
public class NewPostBuilder extends BaseBuilder {

    @Override
    public NewPostBuilder url(String url) {
    ...
    @Override
    public NewPostBuilder tag(Object tag) {
        return this;
    }
    ...
    public BaseCall abstractBuild() {
        ...
        build = new Request.Builder()
                .header("Authorization", "Basic d29ybGQtaG91c2UtYXBwOjEyMzQ1Ng==")
    ...
    @Override
    public NewPostBuilder params(String k, String v) {
        params.put(k, v);
        return this;
    }

    public NewPostBuilder params(Map<String, String> params) {
