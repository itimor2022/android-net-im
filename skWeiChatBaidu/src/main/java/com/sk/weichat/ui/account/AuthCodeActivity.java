...
public class AuthCodeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        btnForgetPassword = findViewById(R.id.forget_password_btn);
        btnForgetPassword.setOnClickListener(v -> startActivity(new Intent(mContext, FindPwdActivity.class)));

        btnRegister = findViewById(R.id.register_account_btn);
    ...
    private void setProtocol() {
        ...
        ClickableSpan clickableSpan1 = new ClickableSpan() {
            @Override
            public void onClick(View view) {
                PrivacyAgreeActivity.startIntent(AuthCodeActivity.this);
            }
        ...
        ClickableSpan clickableSpan2 = new ClickableSpan() {
            @Override
            public void onClick(View view) {
                PrivacyAgreeActivity.startPrivacy(AuthCodeActivity.this, coreManager.getConfig().privacyPolicyPrefix);
            }
    ...
    private void login() {
        ...
        if (!checkBox.isChecked()) {
            ToastUtil.showToast(AuthCodeActivity.this, "请仔细阅读用户协议和隐私协议");
