...
public class RegisterUserBasicInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void takePhoto() {
        mNewPhotoUri = CameraUtil.getOutputMediaFileUri(this, CameraUtil.MEDIA_TYPE_IMAGE, true);
...
//                    Uri o = Uri.fromFile(new File(CameraUtil.parsePickImageResult(data)));
                    Uri o = FileUtil.getUriForFile(this, new File(CameraUtil.parsePickImageResult(data)));
//                    mNewPhotoUri = CameraUtil.getOutputMediaFileUri(this, CameraUtil.MEDIA_TYPE_IMAGE);
            ...
            if (resultCode == Activity.RESULT_OK) {
                isSelectAvatar = true;
                if (mNewPhotoUri != null) {
                    String filePath = FileUtil.getExternalImgFilePathFromUri(this, mNewPhotoUri);
                    mCurrentFile = new File(filePath);
                    AvatarHelper.getInstance().displayUrl(mNewPhotoUri.toString(), mAvatarImg);
                    Log.d("uploadAvator", mNewPhotoUri.getPath()+"=>"+mNewPhotoUri.toString()+"=>"+mCurrentFile.exists());
                } else {
