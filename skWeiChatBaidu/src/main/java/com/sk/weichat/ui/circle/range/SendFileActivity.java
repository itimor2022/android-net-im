    ...
    private void initView() {
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isBoolBan) {
                    ButtonColorChange.checkChange(SendFileActivity.this, checkBox);
                } else {
        ...
        tv_title_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(mFilePath)) {
                    Toast.makeText(SendFileActivity.this, getString(R.string.add_file), Toast.LENGTH_SHORT).show();
                    return;
                }
...
*/
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                DialogHelper.dismissProgressDialog();
                startActivity(new Intent(SendFileActivity.this, SelectLoginModeActivity.class));
            } else if (result == 2) {
                DialogHelper.dismissProgressDialog();
                ToastUtil.showToast(SendFileActivity.this, getString(R.string.alert_not_have_file));
            } else if (result == 3) {
                DialogHelper.dismissProgressDialog();
