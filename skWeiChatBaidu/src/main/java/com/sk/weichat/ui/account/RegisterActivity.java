...
//        }
    ...
    private void setProtocol(){
        ...
        ClickableSpan clickableSpan1 = new ClickableSpan() {
            @Override
            public void onClick(View view) {
                PrivacyAgreeActivity.startIntent(RegisterActivity.this);
            }
        ...
        ClickableSpan clickableSpan2 = new ClickableSpan() {
            @Override
            public void onClick(View view) {
                PrivacyAgreeActivity.startPrivacy(RegisterActivity.this, coreManager.getConfig().privacyPolicyPrefix);
            }
            @Override
            public void updateDrawState(TextPaint ds) {
                //点击事件去掉下划线
        ...
        mNextStepBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkBox.isChecked()){
                    ...
                    ToastUtil.showToast(RegisterActivity.this, "请仔细阅读用户协议和隐私协议");
