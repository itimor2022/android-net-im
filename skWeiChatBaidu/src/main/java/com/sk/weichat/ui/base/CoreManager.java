...
public class CoreManager {
    ...
    public static int currLoginPipe = 0;
    @Nullable
        ...
        if (staticConfig == null) {
            synchronized (CoreManager.class) {
                if (staticConfig == null) {
                    ...
                    if (configBean == null || StringUtil.isBlank(configBean.getApiUrl())) {
    ...
    public void refreshConfig(Context ctx) {
        AppConfig tempConfig = getConfig();
...
//        getDefaultConfig(ctx);
        setStaticConfig(ctx, AppConfig.initConfig(configBean,tempConfig));
    }
        ...
        if (staticSelf == null) {
            synchronized (CoreManager.class) {
                if (staticSelf == null) {
                    ...
                    if (user == null) {
                        LogUtils.e("com.sk.weichat.ui.base.CoreManager.requireSelf", "登录的User为空:"+ userId);
