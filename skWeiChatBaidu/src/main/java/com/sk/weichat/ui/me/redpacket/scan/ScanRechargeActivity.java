...
public class ScanRechargeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showRechargeMethod() {
        AppConfig cfg = coreManager.getConfig();
        findViewById(R.id.recharge_wechat).setVisibility(cfg.enableWxPay ? View.VISIBLE : View.GONE);
        findViewById(R.id.recharge_alipay).setVisibility(cfg.enableAliPay ? View.VISIBLE : View.GONE);
//        findViewById(R.id.recharge_band).setOnClickListener(this);
        findViewById(R.id.recharge_usdt).setVisibility(cfg.enableUsdtPay ? View.VISIBLE : View.GONE);
    }
    ...
    private void initEvent() {
        ...
        findViewById(R.id.recharge_band).setOnClickListener(this);
        findViewById(R.id.recharge_usdt).setOnClickListener(this);
    }
