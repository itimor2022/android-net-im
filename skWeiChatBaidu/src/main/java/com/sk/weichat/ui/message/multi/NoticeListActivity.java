...
//            params.put("notice", URLEncoder.encode(text, StandardCharsets.UTF_8.toString()));
...
//            params.put("noticeContent", URLEncoder.encode(NewNotice, StandardCharsets.UTF_8.toString()));
