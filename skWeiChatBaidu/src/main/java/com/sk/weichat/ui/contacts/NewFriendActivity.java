...
public class NewFriendActivity extends BaseActivity implements NewFriendListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.lin_phone_contact).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // 清空新联系人数量
                PreferenceUtils.putInt(NewFriendActivity.this, Constants.NEW_CONTACTS_NUMBER + mLoginUserId, 0);
                Intent intentGroup = new Intent(NewFriendActivity.this, ContactsActivity.class);
                NewFriendActivity.this.startActivity(intentGroup);
            }
        });
    }
