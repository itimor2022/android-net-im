...
import com.sk.weichat.view.DoubleTipDialog;
...
public class SecureSettingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.rl_unregister).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    DoubleTipDialog dialog;
    private void showDoubleTips(){
        dialog = new DoubleTipDialog(this, getString(R.string.double_tips_message));
        dialog.setConfirmOnClickListener( new TipDialog.ConfirmOnClickListener() {
            @Override
            public void confirm() {
                ToastUtil.showToast(SecureSettingActivity.this, "15个工作日后账号注销");
                ...
                startActivity(new Intent(SecureSettingActivity.this, SelectLoginModeActivity.class));
//                LoginHistoryActivity.start(SecureSettingActivity.this);
                finish();
            }
        });
        dialog.show();
