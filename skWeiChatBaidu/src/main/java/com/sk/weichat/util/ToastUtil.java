...
public class ToastUtil {
    ...
    public static void showNetError(Context context,String error) {
        if (context == null) {
            return;
        }
        // realShowToast(context, context.getString(R.string.net_exception), Toast.LENGTH_SHORT);
        realShowToast(context, context.getString(R.string.request_exception)+error, Toast.LENGTH_SHORT);
    }
