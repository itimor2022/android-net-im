...
public class MsgBroadcast {
    ...
    public static final String ACTION_MSG_CLEAR_AND_REFRESH_CHAT_LIST = AppConfig.sPackageName + ".action.refresh_chatroom_current_msglist"; // 通知聊天界面刷新聊天数据
    ...
    // 通知聊天界面刷新聊天列表
    public static void broadcastRefreshChatList(Context context) {
        Intent intent = new Intent(ACTION_MSG_CLEAR_AND_REFRESH_CHAT_LIST);
        context.sendBroadcast(intent);
    }
