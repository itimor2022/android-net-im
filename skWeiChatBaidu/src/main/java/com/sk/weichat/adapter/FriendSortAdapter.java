    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (friend.getRoomFlag() == 0) {// 单人
            ...
            if (friend.getUserId().equals(Friend.ID_SYSTEM_MESSAGE)) {
                avatar_img.setImageResource(R.drawable.icon_new_kefu);
                ...
                if ("android".equals(friend.getUserId())) {
                    avatar_img_divices.setImageResource(R.drawable.my_iphone_icon);
                } else if ("ios".equals(friend.getUserId())) {
                    avatar_img_divices.setImageResource(R.drawable.my_iphone_icon);
                } else if ("mac".equals(friend.getUserId())) {
                    avatar_img_divices.setImageResource(R.drawable.my_mac_computer_icon);
                } else if ("web".equals(friend.getUserId())) {
                    avatar_img_divices.setImageResource(R.drawable.my_web_icon);
