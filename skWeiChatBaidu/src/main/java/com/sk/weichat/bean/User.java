...
public class User implements Parcelable, Cloneable {
    ...
    protected User(Parcel in) {
        ...
        createRoomLevel = in.readInt();
        signDayCount = in.readInt();
    }
    ...
    public boolean equals(Object o) {
        ...
        equals &= createRoomLevel == other.createRoomLevel;
        equals &= signDayCount == other.signDayCount;
        // 下面两个成员变量不比较
    ...
    public int getCreateRoomLevel() {
        return createRoomLevel;
    }

    public void setCreateRoomLevel(int createRoomLevel) {
        this.createRoomLevel = createRoomLevel;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(createRoomLevel);
        dest.writeInt(signDayCount);
    }
