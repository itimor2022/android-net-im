...
public class ConfigBean {
    ...
    private int uploadVersion = 0;  // 强制更新配置，为0不强制，1强制
    private String downloadUrl;// 头像以外的东西的下载地址uploadVersion
    ...
    private int enableUsdtPay = 0;//是否启用 usdt充值
    private int enableWxWithdrawal = 0;
    private int enableAliWithdrawal = 0;
    private int enableBankWithdrawal = 0;
    private int enableUsdtWithdrawal = 0;
    private String macAppUrl;
    private String macExplain;
    private String XMPPDomain2;
    private String XMPPHost2;
    private String apiUrl2;
    private String downloadUrl2;
    private String jitsiServer2;

    public String getXMPPDomain2() {
        return XMPPDomain2;
    }

    public void setXMPPDomain2(String XMPPDomain2) {
        this.XMPPDomain2 = XMPPDomain2;
    }

    public String getXMPPHost2() {
        return XMPPHost2;
    }

    public void setXMPPHost2(String XMPPHost2) {
        this.XMPPHost2 = XMPPHost2;
    }
    ...
    public String getJitsiServer2() {
        return jitsiServer2;
    }

    public void setJitsiServer2(String jitsiServer2) {
        this.jitsiServer2 = jitsiServer2;
    }
    ...
    public int getEnableUsdtPay() {
        return enableUsdtPay;
    }

    public void setEnableUsdtPay(int enableUsdtPay) {
        this.enableUsdtPay = enableUsdtPay;
    }

    public int getEnableWxWithdrawal() {
        return enableWxWithdrawal;
    }

    public void setEnableWxWithdrawal(int enableWxWithdrawal) {
        this.enableWxWithdrawal = enableWxWithdrawal;
    }

    public int getEnableAliWithdrawal() {
        return enableAliWithdrawal;
    }

    public void setEnableAliWithdrawal(int enableAliWithdrawal) {
        this.enableAliWithdrawal = enableAliWithdrawal;
    }
    ...
    public int getEnableBankWithdrawal() {
        return enableBankWithdrawal;
    }

    public void setEnableBankWithdrawal(int enableBankWithdrawal) {
        this.enableBankWithdrawal = enableBankWithdrawal;
    }

    public int getEnableUsdtWithdrawal() {
        return enableUsdtWithdrawal;
    }

    public void setEnableUsdtWithdrawal(int enableUsdtWithdrawal) {
        this.enableUsdtWithdrawal = enableUsdtWithdrawal;
    }
    ...
    private int showGroupManagerAction = 0; // 是否显示踢人、禁言消息 0: 不显示 1：显示

    public int getResearchSwitch() {
        return researchSwitch;
    }

    public void setResearchSwitch(int researchSwitch) {
        this.researchSwitch = researchSwitch;
    }

    private int researchSwitch;
    ...
    public String getPipeInfo(String text1,String text2){
        if (CoreManager.currLoginPipe == 0){
            return TextUtils.isEmpty(text1)?text2:text1;
        }
        if (CoreManager.currLoginPipe == 1){
            return TextUtils.isEmpty(text2)?text1:text2;
        }
        return text1;
    }
    ...
    public int getShowGroupManagerAction() {
        return showGroupManagerAction;
    }

    public void setShowGroupManagerAction(int showGroupManagerAction) {
        this.showGroupManagerAction = showGroupManagerAction;
    }
