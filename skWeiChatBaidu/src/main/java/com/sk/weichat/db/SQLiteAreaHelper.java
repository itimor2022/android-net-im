...
public class SQLiteAreaHelper extends OrmLiteSqliteOpenHelper {
    public static final String DATABASE_NAME = "constant_1.db";
    private static final String TAG = "SQLiteHelper";
    private static final int DATABASE_VERSION = 11;

    // public static final String DATABASE_PATH = Config.SDCARD_PATH +
    // File.separator + "shiku" + File.separator + "shiku.db";
    public SQLiteAreaHelper(Context context) {
    ...
    public static void rebuildDatabase(Context ctx) {
        ctx.deleteDatabase(SQLiteAreaHelper.DATABASE_NAME);
    ...
    public static void copyDatabaseFile(Context context) {
        File dbFile = context.getDatabasePath(SQLiteAreaHelper.DATABASE_NAME);
        if (dbFile.exists()) {
            return;
        }
...
//        try {
//            TableUtils.createTableIfNotExists(connSource, Area.class);
...
//            rw.closeQuietly();
//            TableUtils.dropTable(connSource, Area.class, false);
//        } catch (SQLException e) {
//            e.printStackTrace();
//        }
    }
