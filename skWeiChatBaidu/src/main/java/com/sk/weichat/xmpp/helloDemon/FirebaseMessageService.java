...
public class FirebaseMessageService extends FirebaseMessagingService {
    ...
    private static void sendRegistrationToServer(Context ctx) {
        ...
        com.sk.weichat.util.log.LogUtils.e(TAG, "sendRegistrationToServer: " + refreshedToken);
        if (TextUtils.isEmpty(refreshedToken)) {
            com.sk.weichat.util.log.LogUtils.e(TAG, "还没拿到token，不上传token");
            return;
        }
        ...
        if (status == null || TextUtils.isEmpty(status.accessToken)) {
            ...
            com.sk.weichat.util.log.LogUtils.e(TAG, "还没登录，不上传token");
            return;
        }
        ...
        HttpUtils.post()
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onError(Call call, Exception e) {
                        com.sk.weichat.util.log.LogUtils.e("上传谷歌推送fcm token失败，", "", e);
                    }
                });
    }
    ...
    public void onNewToken(String s) {
        ...
        if (!enabled) {
            com.sk.weichat.util.log.LogUtils.e(TAG, "onNewToken: 谷歌推送fcm还没启用");
            return;
        }
