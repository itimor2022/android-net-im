...
public class VivoPushMessageReceiver extends OpenClientPushMessageReceiver {
    ...
    public static void init(Context ctx) {
        ...
        PushClient.getInstance(ctx).turnOnPush(state -> {
            if (state != 0) {
                com.sk.weichat.util.log.LogUtils.e(TAG, "vivo push: 打开push异常[" + state + "]");
            } else {
    ...
    public static void putRegId(String accessToken, String regId) {
        ...
        if (at == null) {
            com.sk.weichat.util.log.LogUtils.e(TAG, "access token is null");
        } else {
            HttpUtils.post()
                    ...
                    .execute(new BaseCallback<Void>(Void.class) {
                        ...
                        public void onError(Call call, Exception e) {
                            com.sk.weichat.util.log.LogUtils.e(TAG, "上传谷vivo推送Id失败，", e);
                        }
                    });
        }
    }
