...
public class Nav1Fragment extends EasyFragment implements View.OnClickListener {
    ...
    private List<WebItemFragment> fragments;
    private RecyclerView recy_tab;
    private MyAdapter mAdapter;
    private int selected = 0;
    private WebItemFragment currFragment;
    ...
    private void initView() {
        ...
        recy_tab.setVisibility(View.GONE);
    }
    ...
    private void changeFragment(int position) {
        ...
        currFragment = fragments.get(position);
...
//        transaction.show(fragment);
        transaction.replace(R.id.main_content, currFragment);
        transaction.commit();
    }

    public boolean canGoBack(){
        if (currFragment != null){
            return currFragment.canGoBack();
        }
        return true;
    }
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(final MyAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
